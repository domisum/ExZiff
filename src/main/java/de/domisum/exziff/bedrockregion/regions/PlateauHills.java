...
public class PlateauHills extends BedrockRegion
{
	...
	{
		this.heightMultiplier = RandomUtil.getFromRange(0.7, 1.5, random);


		NoiseLayers noiseLayers = new NoiseLayers(new NoiseLayer(70, 30, random.nextLong()),
				new NoiseLayer(30, 10, random.nextLong()), new NoiseLayer(15, 4, random.nextLong()));
