...
public class ContinentsPolygonValidator
{
	...
	// SETTINGS
	@Getter @Setter private double minToOtherPolygonDistance = 0.08;
	@Getter @Setter private double minToEdgeDistance = 0.08;
	@Getter @Setter private double minConvexCornerAngleDeg = 35;
	@Getter @Setter private double minConcaveCornerAngleDeg = 50;
	@Getter @Setter private double minLineToLineDistance = 0.06;
