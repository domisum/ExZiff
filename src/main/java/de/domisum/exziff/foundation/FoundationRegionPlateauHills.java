...
public class FoundationRegionPlateauHills extends FoundationRegion
{
	...
	@Override public void generate()
	{
		...
		NoiseLayer[] layers = new NoiseLayer[] {new NoiseLayer(70, 30, this.seedRandom.nextLong()),
		...
		layers = new NoiseLayer[] {new NoiseLayer(5, 1, this.seedRandom.nextLong())};
		this.afterTerraceNoise = new LayeredOpenSimplexNoise(layers);

		layers = new NoiseLayer[] {new NoiseLayer(40, 4, this.seedRandom.nextLong()),
				new NoiseLayer(10, 1, this.seedRandom.nextLong())};
		this.stepsNoise = new LayeredOpenSimplexNoise(layers);
	}
